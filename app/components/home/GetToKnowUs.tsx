      ...
      <div className="mx-auto w-full max-w-7xl px-6">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          <div className="relative lg:col-span-6">
            <div className="absolute left-0 top-6 h-28 w-2 rounded-full bg-amber-600" />
            ...
            <div className="relative pl-6 sm:pl-10">
              ...
              <div className="absolute bottom-12 right-8 hidden sm:block">
                <div className="h-14 w-14 rounded-full bg-red-600 shadow-2xl shadow-black/30 grid place-items-center">
              ...
              <div className="pointer-events-none absolute -bottom-10 right-8 h-20 w-24 overflow-hidden">
                <svg viewBox="0 0 96 80" className="h-full w-full" preserveAspectRatio="none" aria-hidden="true">
                  <path d="M0,80 L96,20 L96,80 Z" fill="#dc2626" />
                </svg>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="pt-4 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-red-600">Operations</p>
                </div>
              </div>
            </div>
          </div>
