...
export default function Hero() {
  return (
    <section className="relative h-[56vh] sm:h-[72vh] lg:h-[82vh] w-full overflow-hidden bg-black flex items-center">
      {/* BACKGROUND VIDEO */}
      <video
        className="absolute inset-0 h-full w-full object-cover object-center sm:scale-105 opacity-55 sm:opacity-60"
        autoPlay
        muted
        loop
        playsInline
        ...
        <div className="w-full max-w-4xl space-y-6 sm:space-y-10 relative z-10 text-left">
          <div className="space-y-3 sm:space-y-6">
            <h1 className="text-3xl sm:text-6xl lg:text-8xl font-black text-white leading-[1.1] tracking-tighter">
              ...
              <span className="block text-emerald-300">done right.</span>
            </h1>
            <p className="text-base sm:text-2xl text-zinc-300 max-w-2xl mx-0 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300">
              Safe execution. Reliable delivery. Fast support.
            </p>
          </div>
