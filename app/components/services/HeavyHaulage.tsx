    ...
    >
      ...
      <div className="flex items-start justify-between gap-6">
        <div>
          ...
          <h3 className="mt-4 text-2xl font-black text-zinc-900 leading-tight">Heavy <br/>Haulage</h3>
        </div>
      ...
      <p className="mt-6 text-zinc-500 leading-relaxed font-medium">
        Abnormal loads and low-bed transport for heavy equipment. Complete route planning,
        permits support, and dedicated on-site coordination.
      </p>
    </section>
  );
}
